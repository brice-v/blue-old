...
type Node interface {
	// Display is used for printint ast info to the console
	Display() string
...
func (i *Identifier) Display() string {
...
func (vars *VarStatement) Display() string {
	return "VarStatement: " + vars.String()
}
...
func (vals *ValStatement) Display() string {
	return "ValStatement: " + vals.String()
}
...
func (fs *FunctionStatement) Display() string {
	var out bytes.Buffer
	out.WriteString("FunctionStatement{Name: '")
	out.WriteString(fs.Name.Value)
	out.WriteString("', Parameters: [")
	for i, name := range fs.Parameters {
		out.WriteString("'")
		out.WriteString(name.Value)
		out.WriteString("'")
		if len(fs.Parameters) > i+1 {
			out.WriteString(", ")
		}
	}
	out.WriteString("], ")
	out.WriteString(fs.Body.Display())
	out.WriteString("}")
	return out.String()
}
...
func (rs *ReturnStatement) Display() string {
	return "ReturnStatement: " + rs.String()
}
...
func (es *ExpressionStatement) Display() string {
	var out bytes.Buffer
	out.WriteString("ExpressionStatement{")
	out.WriteString(es.Expression.Display())
	out.WriteString("}")
	return out.String()
}
...
func (bil *BigIntegerLiteral) Display() string {
	return fmt.Sprintf("BigIntegerLiteral{%s}", bil.Value.String())
}
...
func (il *IntegerLiteral) Display() string {
...
func (fl *FloatLiteral) Display() string {
...
func (hl *HexLiteral) Display() string {
	return fmt.Sprintf("HexLiteral{%X}", hl.Value)
}
...
func (ol *OctalLiteral) Display() string {
	return fmt.Sprintf("OctalLiteral{%O}", ol.Value)
}
...
func (bl *BinaryLiteral) Display() string {
	return fmt.Sprintf("BinaryLiteral{%b}", bl.Value)
}
...
func (pe *PrefixExpression) Display() string {
	return fmt.Sprintf("PrefixExpression{Operator: %s, Expression: %s}", pe.Operator, pe.Right.Display())
}
...
func (oe *InfixExpression) Display() string {
	return fmt.Sprintf("InfixExpression{Operator: %s, LeftExpression: %s, RightExpression: %s}",
		oe.Operator, oe.Left.Display(), oe.Right.Display())
}
...
func (ie *IfExpression) Display() string {
	return fmt.Sprintf("IfExpression{Condition: %s, Consequence: %s, Alternative: %s}",
		ie.Condition.Display(), ie.Consequence.Display(), ie.Alternative.Display())
}
...
func (me *MatchExpression) Display() string {
	var out bytes.Buffer
	out.WriteString("MatchExpression{Conditions: [")
	for _, e := range me.Condition {
		out.WriteString(e.Display())
		out.WriteString(", ")
	}
	out.WriteString("], Consequences: [")
	for _, e := range me.Consequence {
		out.WriteString(e.Display())
		out.WriteString(", ")
	}
	out.WriteString("], OptionalValue: ")
	out.WriteString(me.OptionalValue.Display())
	out.WriteString("}")
	return out.String()
}
...
func (bs *BlockStatement) Display() string {
	var out bytes.Buffer
...
func (fl *FunctionLiteral) Display() string {
	var out bytes.Buffer
	out.WriteString("FunctionLiteral{")
	out.WriteString("Parameters: [")
	for i, name := range fl.Parameters {
		out.WriteString("'")
		out.WriteString(name.Value)
		out.WriteString("'")
		if len(fl.Parameters) > i+1 {
			out.WriteString(", ")
		}
	}
	out.WriteString("]")
	out.WriteString(fl.Body.Display())
	out.WriteString("}\n")
	return out.String()
...
func (ce *CallExpression) Display() string {
	var out bytes.Buffer
	out.WriteString("CallExpression{Arguments: [")
	for _, e := range ce.Arguments {
		out.WriteString(e.Display())
		out.WriteString(", ")
	}
	out.WriteString("], DefaultArguments: {")
	for k, v := range ce.DefaultArguments {
	...
	out.WriteString("}, ")
	out.WriteString(ce.Function.Display())
	out.WriteString("}")
	return out.String()
}
...
func (esl *ExecStringLiteral) Display() string {
	return fmt.Sprintf("ExecStringLiteral{`%s`}", esl.Value)
}
...
func (sl *StringLiteral) Display() string {
...
func (ll *ListLiteral) Display() string {
	var out bytes.Buffer
	out.WriteString("ListLiteral{[")
...
func (lcl *ListCompLiteral) Display() string {
	return fmt.Sprintf("ListCompLiteral{NonEvaluatedProgram: %s}", lcl.NonEvaluatedProgram)
}
...
func (ml *MapLiteral) Display() string {
	var out bytes.Buffer
	out.WriteString("MapLiteral{{")
	for k, v := range ml.Pairs {
		out.WriteString(k.Display())
		out.WriteString(": ")
		out.WriteString(v.Display())
		out.WriteString(", ")
	}
...
func (ie *IndexExpression) Display() string {
	var out bytes.Buffer
	out.WriteString("IndexExpression{Left: ")
	out.WriteString(ie.Left.Display())
	out.WriteString(", Index: ")
	out.WriteString(ie.Index.Display())
	out.WriteString("}")
	return out.String()
}
...
func (fe *ForExpression) Display() string {
	var out bytes.Buffer
	out.WriteString("ForExpression{Condition: ")
	out.WriteString(fe.Condition.Display())
	out.WriteString(", ")
	out.WriteString(fe.Consequence.Display())
	out.WriteString("}")
	return out.String()
}
...
func (ae *AssignmentExpression) Display() string {
	return fmt.Sprintf("AssignmentExpression{Left: %s, Value: %s}", ae.Left.Display(), ae.Value.Display())
}
...
func (set *SetLiteral) Display() string {
	var out bytes.Buffer
	out.WriteString("SetLiteral{{")
	for _, e := range set.Elements {
		out.WriteString(e.Display())
		out.WriteString(", ")
	}
...
func (is *ImportStatement) Display() string {
	return "ImportStatement: " + is.String()
}
